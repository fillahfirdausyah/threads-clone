...
const PostCard = ({ post }) => {
  ...
  return (
    <div className="flex items-start post-separator mb-3 py-3 px-3">
      <div className="flex flex-col items-center justify-end me-4">
        ...
        {/* <div className="left-1/2 -ml-0.5 h-[200px] w-0.5 bg-gray-600 my-3"></div> */}
        {/* <div className=" bg-gray-600 mt-10 absolute"></div> */}
      </div>
