...
const CoverPage = () => {
  return (
    <section className="cover min-h-screen max-w-xl mx-auto px-6 mt-3 text-center text-threads-white">
      ...
      <button className="bg-threads-purple-500 w-40 h-10 px-3 py-1 rounded-md text-threads-white text-sm font-medium hover:bg-threads-purple-400 mt-16">
        Let's Join
      </button>
    </section>
  );
